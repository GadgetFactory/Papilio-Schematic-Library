/*
 ...
 To get started click on the bit file link below that corresponds to the type of Papilio board you have. 
 ...
 If you want to modify the circuit then make sure you have Xilinx ISE Webpack installed and click on the appropriate link to modify the schematic below.
